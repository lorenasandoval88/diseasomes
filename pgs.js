...
pgs.pgsPlot = function(data,div) {
    ...
    var layout = {
        height: 500,
        width: 400,
        title: `Odds ratios (OR) for ${data.dt.length} ${data.meta.pgs_id} variants`,
        yaxis: {
...
pgs.plotAllMatchByPos=(data,div2)=>{ 
    ...
    pgs.Plotly.newPlot(div2, [trace0], {
        ...
        title: `<i style="color:navy"> ${data.calcRiskScore.length} ${data.pgs.meta.trait_reported} risk scores, PRS ${Math.round(data.PRS*1000)/1000}</i>
